...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   merge_sort_no_malloc.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: fedmarti <fedmarti@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/01 23:03:36 by fedmarti          #+#    #+#             */
/*   Updated: 2023/04/06 17:38:17 by fedmarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	prepare_for_merge_b(t_data *data, int size)
{
	...
	if (ft_abs(dist_a) + ft_abs(dist_b) < abs_min(dist_a, dist_b)
		+ ft_abs(get_distance(data->stack_a, target_a, target_b)))
	{
